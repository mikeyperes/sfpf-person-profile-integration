...
[founder action="display_socials"]',
    ...
    'location_born' => [
        'title' => 'Location Born Page',
        'description' => 'Template for the location born sub-page.',
        'default' => '[founder action="display_location_born"]',
    ],
    'organizations_founded' => [
        'title' => 'Organizations Founded Page',
        'description' => 'Template for organizations founded sub-page.',
        'default' => '[founder action="display_organizations_founded"]',
    ],
    'professions' => [
...
[founder action="display_professions_with_summary"]',
    ...
    'recent_articles' => [
        'title' => 'Recent Articles Page',
        'description' => 'Template for the recent articles page.',
        'default' => '[founder action="display_articles"]',
    ],
    'connect' => [
        'title' => 'Connect Page',
        'description' => 'Template for the connect/contact page.',
        'default' => '<h2>Connect</h2>
