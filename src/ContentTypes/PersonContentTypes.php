        ...
        self::$acf_groups
            ->add(
                [
                    ...
                    'fields' => [ 'Entity Type', 'Biography', 'Short Biography', 'Mission Statement', 'Professions', 'Education', 'Awards', 'Languages', 'Birth Details', 'Contact Details', 'SameAs URLs', 'Knowledge Graph ID', 'Gallery', 'FAQ', 'Articles' ],
