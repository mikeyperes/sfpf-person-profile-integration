...
$assert( '1.8.3' === SFPF_PLUGIN_VERSION, 'Unexpected plugin version.' );
$assert( version_compare( (string) ( $report['selected']['version'] ?? '0' ), '0.19.78', '>=' ), 'Selected Core version is older than 0.19.78.' );
...
echo 'PASS: WordPress loaded SFPF 1.8.3 with grouped Core tabs, action-scoped AJAX modules, and guarded runtime hooks.' . PHP_EOL;
