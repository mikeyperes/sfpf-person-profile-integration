...
$assert( '3.1.4' === SFPF_PLUGIN_VERSION, 'Unexpected plugin version.' );
...
echo 'PASS: WordPress loaded SFPF 3.1.4 with canonical Organization ownership and bounded queries.' . PHP_EOL;
