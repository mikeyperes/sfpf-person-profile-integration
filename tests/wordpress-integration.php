...
$assert( '3.1.1' === SFPF_PLUGIN_VERSION, 'Unexpected plugin version.' );
$assert( version_compare( (string) ( $report['selected']['version'] ?? '0' ), '3.0.4', '>=' ), 'Selected Core version is older than the bundled release.' );
...
echo 'PASS: WordPress loaded SFPF 3.1.1 with canonical Organization ownership and bounded queries.' . PHP_EOL;
