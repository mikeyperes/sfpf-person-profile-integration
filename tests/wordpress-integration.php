...
$assert( '1.8.2' === SFPF_PLUGIN_VERSION, 'Unexpected plugin version.' );
...
echo 'PASS: WordPress loaded SFPF 1.8.2 with grouped Core tabs, action-scoped AJAX modules, and guarded runtime hooks.' . PHP_EOL;
