...
$assert( '2.0.10' === SFPF_PLUGIN_VERSION, 'Unexpected plugin version.' );
...
echo 'PASS: WordPress loaded SFPF 2.0.10 with optional profile content types and bounded frontend queries.' . PHP_EOL;
